...
void __fastcall TForm1::Timer_pilkaTimer(TObject *Sender)
{
 ...
 if(b->Top>p->Top+p->Height+10)
 {
  ...
  b ->Visible = false;
  Button1 -> Caption = "Przegrana!!. Ponownie?";
 ...
 if(do_wygranej <=0)
 {
  Timer_pilka ->Enabled =false;
  b ->Visible = false;
  Button1 -> Caption = "Wygrana!, Ponownie?";
  Button1 -> Visible = true;
 }
...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
  ...
  Image1 -> Visible = true; Image2  -> Visible = true; Image3 -> Visible = true; Image4 -> Visible = true;
  Image5 -> Visible = true; Image6  -> Visible = true; Image7 -> Visible = true; Image8  -> Visible = true;
  Image9 -> Visible = true; Image10 -> Visible = true; Image11 -> Visible = true; Image12 -> Visible = true;
}
//---------------------------------------------------------------------------
